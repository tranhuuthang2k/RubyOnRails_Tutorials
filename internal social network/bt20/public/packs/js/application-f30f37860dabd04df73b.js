...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("NotificationsChannel", {
  ...
  received: function received(data) {
    console.log($('.badge+' + data.received_id).html(""));
    $('.badge+' + data.received_id).html("");
    $('.badge+' + data.received_id).append(data.count); // Called when there's incoming data on the websocket for this channel
  }
});
...
/******/ });
//# sourceMappingURL=application-f30f37860dabd04df73b.js.map