...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("NotificationsChannel", {
  ...
  received: function received(data) {
    ...
    $('.notifications').find("#icon-badge+" + 133).html("");
    $('.notifications').find("#icon-badge+" + 133).append(data.count); // Called when there's incoming data on the websocket for this channel
...
/******/ });
//# sourceMappingURL=application-86329c3d0003a10b1422.js.map