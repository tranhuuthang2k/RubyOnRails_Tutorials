...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("NotificationsChannel", {
  ...
  received: function received(data) {
    console.log(data.received_id);
    $('#icon-badge-' + data.received_id).html("");
    $('#icon-badge-' + data.received_id).append(data.count); // $('.notifications-'+'133').append(data.count)
    // $('.badge+' + data.received_id).append(data.count)
    // $('.notifications').find("#badge+133").html("")
    // $('.notifications').find("#badge+133").append(data.count)
...
/******/ });
//# sourceMappingURL=application-ebc4a562e8fbd3e23d56.js.map