...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("NotificationsChannel", {
  ...
  received: function received(data) {
    ...
    $('.notifications').find("#icon-badge+" + data.received_id).append(data.count); // Called when there's incoming data on the websocket for this channel
...
/******/ });
//# sourceMappingURL=application-efefb673e9e161328abd.js.map