...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("NotificationsChannel", {
  ...
  received: function received(data) {
    ...
    $('.notifications').find("#badge+" + 133).append(data.count); // Called when there's incoming data on the websocket for this channel
...
/******/ });
//# sourceMappingURL=application-6d9959fc12853b183b58.js.map