...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("NotificationsChannel", {
  ...
  received: function received(data) {
    console.log(data);
    $('.notifications').find("#icon-badge").find('.badge+133').html(""); // $('.notifications').find(".badge+133").append(data.count)
    // $('.badge+133').append(data.count)
...
/******/ });
//# sourceMappingURL=application-1e3d2bfd0c83d5601c24.js.map