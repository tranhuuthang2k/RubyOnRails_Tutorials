...
_consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create("NotificationsChannel", {
  ...
  received: function received(data) {
    console.log(data);
    $('.notifications-' + '133').html("");
    $('.notifications-' + '133').append(data.count); // $('.badge+' + data.received_id).append(data.count)
...
/******/ });
//# sourceMappingURL=application-80fb40ffc3a2a6c825fa.js.map