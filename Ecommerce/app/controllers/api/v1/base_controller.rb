class Api::V1::BaseController < ApplicationController
  ...
  def require_jwt
    ...
    return render json: unauthorized_message('Unauthorized JWT empty') if !token
    render json: unauthorized_message('Unauthorized JWT not valid') if !valid_token(token)
  end
  ...
  def valid_token(token)
    ...
    begin
      ...
      return decoded_token.first['data']  == 'shopvn.com'
